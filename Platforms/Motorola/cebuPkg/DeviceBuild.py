...
class CommonPlatform ():
    PackagesSupported = ("cebuPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('cebu', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "cebu", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "cebuPkg/cebu.dsc", "Platform Hardcoded")
