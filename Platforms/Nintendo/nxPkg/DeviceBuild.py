...
class CommonPlatform ():
    PackagesSupported = ("nxPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('nx', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "nx", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "nxPkg/nx.dsc", "Platform Hardcoded")
