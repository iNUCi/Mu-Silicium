...
class CommonPlatform ():
    PackagesSupported = ("j706fPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('j706f', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "j706f", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "j706fPkg/j706f.dsc", "Platform Hardcoded")
