...
class CommonPlatform ():
    PackagesSupported = ("b5qPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('b5q', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "b5q", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "b5qPkg/b5q.dsc", "Platform Hardcoded")
