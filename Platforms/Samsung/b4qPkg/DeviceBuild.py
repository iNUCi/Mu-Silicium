...
class CommonPlatform ():
    PackagesSupported = ("b4qPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('b4q', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "b4q", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "b4qPkg/b4q.dsc", "Platform Hardcoded")
