...
class CommonPlatform ():
    PackagesSupported = ("r8sPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('r8s', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "r8s", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "r8sPkg/r8s.dsc", "Platform Hardcoded")
