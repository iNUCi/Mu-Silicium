...
class CommonPlatform ():
    PackagesSupported = ("c1sPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('c1s', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "c1s", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "c1sPkg/c1s.dsc", "Platform Hardcoded")
