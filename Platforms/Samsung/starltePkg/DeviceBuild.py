...
class CommonPlatform ():
    PackagesSupported = ("starltePkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('starlte', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "starlte", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "starltePkg/starlte.dsc", "Platform Hardcoded")
