...
class CommonPlatform ():
    PackagesSupported = ("r8qPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('r8q', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "r8q", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "r8qPkg/r8q.dsc", "Platform Hardcoded")
