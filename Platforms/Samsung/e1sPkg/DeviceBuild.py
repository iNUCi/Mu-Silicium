...
class CommonPlatform ():
    PackagesSupported = ("e1sPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('e1s', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "e1s", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "e1sPkg/e1s.dsc", "Platform Hardcoded")
