...
class CommonPlatform ():
    PackagesSupported = ("q2qPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('q2q', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "q2q", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "q2qPkg/q2q.dsc", "Platform Hardcoded")
