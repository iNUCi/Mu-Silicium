...
class CommonPlatform ():
    PackagesSupported = ("r0qPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('r0q', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "r0q", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "r0qPkg/r0q.dsc", "Platform Hardcoded")
