...
class CommonPlatform ():
    PackagesSupported = ("gta4lPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('gta4l', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "gta4l", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "gta4lPkg/gta4l.dsc", "Platform Hardcoded")
