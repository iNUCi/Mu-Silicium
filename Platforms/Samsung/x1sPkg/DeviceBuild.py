...
class CommonPlatform ():
    PackagesSupported = ("x1sPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('x1s', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "x1s", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "x1sPkg/x1s.dsc", "Platform Hardcoded")
