...
class CommonPlatform ():
    PackagesSupported = ("a52sxqPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('a52sxq', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "a52sxq", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "a52sxqPkg/a52sxq.dsc", "Platform Hardcoded")
