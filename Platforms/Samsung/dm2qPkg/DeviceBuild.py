...
class CommonPlatform ():
    PackagesSupported = ("dm2qPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('dm2q', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "dm2q", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "dm2qPkg/dm2q.dsc", "Platform Hardcoded")
