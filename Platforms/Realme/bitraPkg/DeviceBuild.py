...
class CommonPlatform ():
    PackagesSupported = ("bitraPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('bitra', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "bitra", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "bitraPkg/bitra.dsc", "Platform Hardcoded")
