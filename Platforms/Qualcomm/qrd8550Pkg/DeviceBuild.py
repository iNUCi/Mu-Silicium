...
class CommonPlatform ():
    PackagesSupported = ("qrd8550Pkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('qrd8550', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "qrd8550", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "qrd8550Pkg/qrd8550.dsc", "Platform Hardcoded")
