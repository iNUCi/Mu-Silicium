...
class CommonPlatform ():
    PackagesSupported = ("nx729jPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('nx729j', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "nx729j", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "nx729jPkg/nx729j.dsc", "Platform Hardcoded")
