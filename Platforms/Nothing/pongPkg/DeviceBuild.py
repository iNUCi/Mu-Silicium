...
class CommonPlatform ():
    PackagesSupported = ("pongPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('pong', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "pong", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "pongPkg/pong.dsc", "Platform Hardcoded")
