...
class CommonPlatform ():
    PackagesSupported = ("spacewarPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('spacewar', 'gcc_aarch64_linux', 'edk2-build')
    ...
    PackagesPath = (
        ...
        "Silicon/Silicium",
        "Silicium-ACPI",
        "Silicium-ACPI/Platforms/Nothing",
...
class SettingsManager (UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager, ParseSettingsManager):
    ...
    def GetPlatformDscAndConfig (self) -> tuple:
        return ("spacewarPkg/spacewar.dsc", {})
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "spacewar", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "spacewarPkg/spacewar.dsc", "Platform Hardcoded")
