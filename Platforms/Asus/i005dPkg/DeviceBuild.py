...
class CommonPlatform ():
    PackagesSupported = ("i005dPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('i005d', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "i005d", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "i005dPkg/i005d.dsc", "Platform Hardcoded")
