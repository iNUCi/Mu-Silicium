...
class CommonPlatform ():
    PackagesSupported = ("ginkgoPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('ginkgo', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "ginkgo", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "ginkgoPkg/ginkgo.dsc", "Platform Hardcoded")
