...
class CommonPlatform ():
    PackagesSupported = ("cepheusPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('cepheus', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "cepheus", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "cepheusPkg/cepheus.dsc", "Platform Hardcoded")
