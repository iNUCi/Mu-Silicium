...
class CommonPlatform ():
    PackagesSupported = ("fogPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('fog', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "fog", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "fogPkg/fog.dsc", "Platform Hardcoded")
