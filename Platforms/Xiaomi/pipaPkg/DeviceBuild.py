...
class CommonPlatform ():
    PackagesSupported = ("pipaPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('pipa', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "pipa", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "pipaPkg/pipa.dsc", "Platform Hardcoded")
