...
class CommonPlatform ():
    PackagesSupported = ("vayuPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('vayu', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "vayu", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "vayuPkg/vayu.dsc", "Platform Hardcoded")
