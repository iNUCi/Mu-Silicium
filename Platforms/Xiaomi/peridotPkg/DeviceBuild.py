...
class CommonPlatform ():
    PackagesSupported = ("peridotPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('peridot', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "peridot", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "peridotPkg/peridot.dsc", "Platform Hardcoded")
