...
class CommonPlatform ():
    PackagesSupported = ("polarisPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('polaris', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "polaris", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "polarisPkg/polaris.dsc", "Platform Hardcoded")
