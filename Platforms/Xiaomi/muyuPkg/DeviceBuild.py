...
class CommonPlatform ():
    PackagesSupported = ("muyuPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('muyu', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "muyu", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "muyuPkg/muyu.dsc", "Platform Hardcoded")
