...
class CommonPlatform ():
    PackagesSupported = ("citrusPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('citrus', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "citrus", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "citrusPkg/citrus.dsc", "Platform Hardcoded")
