...
class CommonPlatform ():
    PackagesSupported = ("viliPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('vili', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "vili", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "viliPkg/vili.dsc", "Platform Hardcoded")
