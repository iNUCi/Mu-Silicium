...
class CommonPlatform ():
    PackagesSupported = ("miatollPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('miatoll', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "miatoll", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "miatollPkg/miatoll.dsc", "Platform Hardcoded")
