...
class CommonPlatform ():
    PackagesSupported = ("suryaPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('surya', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "surya", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "suryaPkg/surya.dsc", "Platform Hardcoded")
