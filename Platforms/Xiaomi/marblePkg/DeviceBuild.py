...
class CommonPlatform ():
    PackagesSupported = ("marblePkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('marble', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "marble", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "marblePkg/marble.dsc", "Platform Hardcoded")
