...
class CommonPlatform ():
    PackagesSupported = ("stonePkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('stone', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "stone", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "stonePkg/stone.dsc", "Platform Hardcoded")
