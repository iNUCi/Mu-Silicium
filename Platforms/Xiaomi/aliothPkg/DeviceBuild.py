...
class CommonPlatform ():
    PackagesSupported = ("aliothPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('alioth', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "alioth", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "aliothPkg/alioth.dsc", "Platform Hardcoded")
