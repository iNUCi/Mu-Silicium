...
class CommonPlatform ():
    PackagesSupported = ("renoirPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('renoir', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "renoir", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "renoirPkg/renoir.dsc", "Platform Hardcoded")
