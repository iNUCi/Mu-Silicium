...
class CommonPlatform ():
    PackagesSupported = ("garnetPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('garnet', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "garnet", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "garnetPkg/garnet.dsc", "Platform Hardcoded")
