...
class CommonPlatform ():
    PackagesSupported = ("ingresPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('ingres', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "ingres", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "ingresPkg/ingres.dsc", "Platform Hardcoded")
