...
class CommonPlatform ():
    PackagesSupported = ("lisaPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('lisa', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "lisa", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "lisaPkg/lisa.dsc", "Platform Hardcoded")
