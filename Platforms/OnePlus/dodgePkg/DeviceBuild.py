...
class CommonPlatform ():
    PackagesSupported = ("dodgePkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('dodge', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "dodge", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "dodgePkg/dodge.dsc", "Platform Hardcoded")
