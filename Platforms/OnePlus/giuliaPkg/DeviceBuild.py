...
class CommonPlatform ():
    PackagesSupported = ("giuliaPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('giulia', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "giulia", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "giuliaPkg/giulia.dsc", "Platform Hardcoded")
