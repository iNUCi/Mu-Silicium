...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "aston", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "astonPkg/aston.dsc", "Platform Hardcoded")
