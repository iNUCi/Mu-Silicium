...
class CommonPlatform ():
    PackagesSupported = ("macanPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('macan', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "macan", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "macanPkg/macan.dsc", "Platform Hardcoded")
