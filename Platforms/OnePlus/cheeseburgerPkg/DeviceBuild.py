...
class CommonPlatform ():
    PackagesSupported = ("cheeseburgerPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('cheeseburger', 'gcc_aarch64_linux', 'edk2-build')
    ...
    PackagesPath = (
        ...
        "Silicon/Silicium",
        "Silicium-ACPI",
        "Silicium-ACPI/Platforms/OnePlus",
...
class SettingsManager (UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager, ParseSettingsManager):
    ...
    def GetPlatformDscAndConfig (self) -> tuple:
        return ("cheeseburgerPkg/cheeseburger.dsc", {})
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "cheeseburger", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "cheeseburgerPkg/cheeseburger.dsc", "Platform Hardcoded")
